...
export const dict = {
  ...
  "settings.commitMessage.model.title": "Modelo",
  "settings.commitMessage.model.description": "Escolha o modelo usado para gerar mensagens de commit do Git. Quando não definido, o modelo pequeno padrão é usado.",
