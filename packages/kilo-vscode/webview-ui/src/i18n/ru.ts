...
export const dict = {
  ...
  "settings.commitMessage.model.description": "Выберите модель, используемую для генерации сообщений коммитов Git. Если она не задана, используется стандартная малая модель.",
